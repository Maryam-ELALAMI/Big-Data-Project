            ...
            if (appState.scanId) {
                try {
                    const [resA, resB] = await Promise.all([
                        fetch(`/api/files/${appState.scanId}/${encodeURIComponent(decodeURIComponent(fileA))}`),
                        fetch(`/api/files/${appState.scanId}/${encodeURIComponent(decodeURIComponent(fileB))}`)
                    ])
