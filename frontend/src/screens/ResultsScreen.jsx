...
export default function ResultsScreen() {
    ...
    // Use mock data if no results available
    const results = appState.results || generateDemoResults()
    ...
    const handleViewComparison = (fileA, fileB) => {
        navigate(`/compare/${encodeURIComponent(fileA)}/${encodeURIComponent(fileB)}`)
    }
